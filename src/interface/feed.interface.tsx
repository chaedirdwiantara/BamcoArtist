...
export type AnalyticMusicianData = {
  ID: number;
  UUID: string;
  Bandname: string;
  Username: string;
  ...
  is_valid: true;
  Labels: string;
  years_active_from: string;
  years_active_to: string;
  ...
  moods: string[];
  expectations: string[];
  roles_in_industry: string[];
  Moods: string[];
  FavoriteGenres: string[];
  Expectations: string[];
  RolesInIndustry: string;
  CountFans: number;
  point: number;
...
export type AnalyticPostData = {
  ...
  quote_to_post: {
    ...
    musician: string;
    image: string;
    encode_dash_url: string;
    encode_hls_url: string;
    start_at: string;
    end_at: string;
  };
  Video: {
