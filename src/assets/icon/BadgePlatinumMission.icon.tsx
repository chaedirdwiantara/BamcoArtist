...
function BadgePlatinumMissionIcon({
    ...
    <View style={[{width, height}, style]}>
      <Svg width={'100%'} height={'100%'} fill={fill} viewBox={'0 0 24 27'}>
        <Path
          ...
          stroke="url(#paint0_linear_3_32602)"
          strokeWidth={1.79437}
        />
        <Mask
          id="a"
        ...
        <G mask="url(#a)">
          <Circle cx={12} cy={13.5} r={11.1028} fill="#6899A0" />
          <Path d="M12 20a6 6 0 010-12v12z" fill="#9BCFD6" />
          <Path d="M12 20a6 6 0 000-12v12z" fill="#80ADB3" />
          <Path d="M12 9.5a4.5 4.5 0 000 9v-9z" fill="#DAF6F5" />
          <Path d="M12 9.5a4.5 4.5 0 010 9v-9z" fill="#9BCFD6" />
          <G clipPath="url(#clip0_3_32602)">
            <Path
        ...
        <Defs>
          <LinearGradient
            id="paint0_linear_3_32602"
            x1={12}
            y1={1.5}
            x2={12}
            y2={25.5}
            gradientUnits="userSpaceOnUse">
            <Stop stopColor="#9BCFD6" />
            <Stop offset={1} stopColor="#80ADB3" />
          </LinearGradient>
          <ClipPath id="clip0_3_32602">
            <Path
              fill="#fff"
...
export default BadgePlatinumMissionIcon;
