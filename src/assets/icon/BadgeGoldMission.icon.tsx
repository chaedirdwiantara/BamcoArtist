    ...
    <View style={[{width, height}, style]}>
      <Svg width={'100%'} height={'100%'} fill={fill} viewBox={'0 0 24 27'}>
        <Path
          ...
          stroke="url(#paint0_linear_3_32387)"
          strokeWidth={1.79437}
        />
        <Mask
          id="a"
        ...
        <G mask="url(#a)">
          <Circle cx={12.0001} cy={13.5} r={11.1028} fill="#D99D01" />
          <Path d="M12 20a6 6 0 010-12v12z" fill="#FABE2C" />
          <Path d="M12 20a6 6 0 000-12v12z" fill="#FF9100" />
          <Path d="M12 9.5a4.5 4.5 0 000 9v-9z" fill="#FED843" />
          <Path d="M12 9.5a4.5 4.5 0 010 9v-9z" fill="#FABE2C" />
          <G clipPath="url(#clip0_3_32387)">
            <Path
        ...
        <Defs>
          <LinearGradient
            id="paint0_linear_3_32387"
            x1={12}
            y1={1.5}
            x2={12}
            y2={25.5}
            gradientUnits="userSpaceOnUse">
            <Stop stopColor="#FEEE97" />
            <Stop offset={1} stopColor="#FFAE34" />
          </LinearGradient>
          <ClipPath id="clip0_3_32387">
            <Path
              fill="#fff"
